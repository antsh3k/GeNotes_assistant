...
st.set_page_config(page_title="GeNotes Genomic Guidelines Assistant", page_icon="🦜")
st.title("🦜 GeNotes Genomic Guidelines Assistant")
...
user_question = st.chat_input("Type your question about genomic guidelines...")
